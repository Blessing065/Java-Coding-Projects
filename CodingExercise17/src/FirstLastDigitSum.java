public class FirstLastDigitSum {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sumFirstAndLastDigit(-10));
        System.out.println(sumFirstAndLastDigit(125897));
        System.out.println(sumFirstAndLastDigit(925897));
        System.out.println(sumFirstAndLastDigit(125891));
        System.out.println(sumFirstAndLastDigit(1258971115));
        System.out.println(sumFirstAndLastDigit(97));
