public class NumberOfDaysInMonth {
    ...
    public static void main(String[] args) {
        System.out.println("For Leap year Method");
        System.out.println("For 2020 " + isLeapYear(-1600));
        System.out.println("For 2020 " + isLeapYear(1600));
        System.out.println("For 2020 " + isLeapYear(2017));
        System.out.println("For 2020 " + isLeapYear(2000));

        System.out.println("");
        System.out.println("");
        System.out.println("");
        System.out.println("");
        System.out.println("For Print days Method");
