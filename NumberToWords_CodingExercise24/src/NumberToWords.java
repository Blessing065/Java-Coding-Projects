...
//        System.out.println(getDigitCount(4789562));
//        System.out.println(getDigitCount(0));
//        System.out.println(getDigitCount(4562));
    ...
    public static void numberToWords(int number) {
        ...
        int digitsForOriginal = getDigitCount(number);
        int digitsForReversed = getDigitCount(reversedNumber);
        if (number < 0) {
            System.out.println("Invalid Value");
        }else if(digitsForOriginal != digitsForReversed){
            for (int i=digitsForReversed;i<=digitsForOriginal;i++){
                while (true) {
